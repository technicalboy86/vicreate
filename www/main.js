...
/* harmony import */ var _app_storage__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./app.storage */ "./src/app/app.storage.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _app_storage__WEBPACK_IMPORTED_MODULE_10__["StorageService"]
            ],
...
/* harmony import */ var _app_storage__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../app.storage */ "./src/app/app.storage.ts");
...
var AuthService = /** @class */ (function () {
    ...
    storageService, env, router, toastController) {
        this.http = http;
    ...
    AuthService.prototype.login = function (email, password) {
        var _this = this;
        return this.http.post(this.env.API_URL + 'loginViaDraglet', { email: email, password: password })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            if (res.token) {
                _this.storageService.add('token', res.token);
    ...
    AuthService.prototype.register = function (username, email, password) {
        return this.http.post(this.env.API_URL + 'registerViaDraglet', { username: username, email: email, password: password }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            return res;
        }));
    };
    AuthService.prototype.logout = function () {
        ...
        return this.http.get(this.env.API_URL + 'auth/logout', { headers: headers })
            ...
            _this.storageService.remove("token");
    ...
    AuthService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"],
            _app_storage__WEBPACK_IMPORTED_MODULE_7__["StorageService"],
            _env_service__WEBPACK_IMPORTED_MODULE_4__["EnvService"],
...
var EnvService = /** @class */ (function () {
    function EnvService() {
        this.API_URL = 'http://35.170.107.207:8081/';
    }
...
module.exports = __webpack_require__(/*! /Users/business-imac/Documents/Projects/ViCreate/src/main.ts */"./src/main.ts");
